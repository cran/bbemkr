warmup = function (x, inicost, mutsizp, warm = 100, prob = 0.234, data_x, 
    data_y, prior_p = 2, prior_st = 1) 
{
    ...
    return(list(x = x, sigma2 = sigma2, cost = inicost, mutsizplast = mutsizpwarm[warm], 
        mutsizp = mutsizpwarm))
}
